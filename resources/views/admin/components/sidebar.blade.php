        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                @php
                    ...
                    $activeRoutes = ['products.all', 'products.create', 'products.edit'];
                @endphp
                ...
                <li class="sidebar-item {{ in_array($route, $activeRoutes) ? 'active' : '' }}">
                    <a href="{{ route('products.all') }}" class='sidebar-link'>
                        <i class="bi bi-grid-1x2-fill"></i>
                        <span>Product</span>
                    </a>
                </li>

                <li class="sidebar-item {{ $route == 'orders.all' ? 'active' : '' }}">
                    <a href="{{ route('orders.all') }}" class='sidebar-link'>
                        <i class="bi bi-grid-1x2-fill"></i>
                        <span>Order</span>
                    </a>
                </li>
